        ...
        ZStack{
            ...
            HStack{
                ...
                VStack{
                    ...
                    .offset(x: self.signal.toggleValue2 ? 0 : 100, y:  self.signal.toggleValue ? -350 : 200)
                ...
                VStack{
                    ...
                    RoundedRectangle(cornerRadius: 10)
                        ...
                        .foregroundColor(self.signal.toggleValue2 ? Color.red : Color.green)
                        .frame(width: 50, height:50)
                        .offset(x: self.signal.toggleValue2 ? 100 : 0, y:  self.signal.toggleValue ? 200 : -350)
                     .animation(Animation.easeInOut(duration: 1.2))
